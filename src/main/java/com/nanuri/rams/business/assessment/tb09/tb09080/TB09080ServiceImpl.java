...
public class TB09080ServiceImpl implements TB09080Service {
	...
	public IBIMS401BVO srchCrdlLdg(IBIMS401BVO input) {
		...
		if ( true ) {
			...
			resObj.setPrdtClsfCd(crdlLdg.getPrdtClsfCd()); // 기업여신상품분류코드
			resObj.setPrdtMdclCd(crdlLdg.getPrdtMdclCd()); // 기업여신상품중분류코드  
			resObj.setPrdtLclsCd(crdlLdg.getPrdtLclsCd()); // 기업여신상품대분류코드 
