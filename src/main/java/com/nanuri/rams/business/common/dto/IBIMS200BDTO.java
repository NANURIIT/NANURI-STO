...
//	private String frcrLoanYn;		            // 외화대출여부
	...
	private String prdtEngAbrvName;           	/* 상품영문약명 */
	private String frstErlmDt;                	/* 최초등록일자 */
	private String saleStrtDt;                	/* 판매시작일자 */
	private String saleEndDt;                 	/* 판매종료일자 */
	private String stdrIntrtKndCd;            	/* 기준금리종류코드 */
	private String lmtBassCd;                 	/* 한도기준코드 */
	private BigDecimal apvlUnitAmt;             /* 승인단위금액 */
	private BigDecimal minApvlAmt;              /* 최소승인금액 */
	private BigDecimal maxApvlAmt;              /* 최대승인금액 */
	private BigDecimal shstCrdlTermMcnt;        /* 최단여신기간개월수 */
	private BigDecimal lgstCrdlTermMcnt;        /* 최장여신기간개월수 */
	private BigDecimal shstDfmtTermMcnt;        /* 최단거치기간개월수 */
	private BigDecimal lgstDfmtTermMcnt;        /* 최장거치기간개월수 */
	private String intAnapDvsnCd;             	/* 이자선후급구분코드 */
